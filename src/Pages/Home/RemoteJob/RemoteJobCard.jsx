...
const RemoteJobCard = ({remotejob}) => {
    const {_id, company_name, job_title, job_category, job_posting_date, application_deadline,compony_logo, salary_range} = remotejob;
    return (
        <div className=" border-2  lg:w-[600px] lg:h-[392px] p-12">
